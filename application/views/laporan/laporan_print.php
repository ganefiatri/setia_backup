...
<div class="row">
    <div class="col-12 col-md-6 col-lg-6" style="">
        <div class="card">
            <div class="card-header" style="">DATA CASE TELKOM</div>
            <div class="card-body">
                <table class="table">
                <thead>
                    <th>Customer Case</th>
...
<div class="row" style="">
    <div class="col-12 col-md-6 col-lg-6">
        <div class="card">
            <div class="card-header" style="">DATA REVENUE TELKOM</div>
            <div class="card-body">
                <table class="table">
                    <thead>
                    <th></th>
    ...
    <div class="col-12 col-md-6 col-lg-6">
        <div class="card">
            <div class="card-header" style="">CROSELLING</div>
            <div class="divclass3 card-body">
                <table class="table">
                    <thead>
