      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo base_url(); ?>dist/index"><img style="height: 100px; width: 100px" src="<?= base_url('gambar/setialogo.png')?>" class="shadow-light rounded-circle" alt=""></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php echo base_url(); ?>dist/index">SA</a>
          </div>
          <ul class="sidebar-menu" style="padding-top: 60px">
...
<!--                  <li><a class="nav-link" href="--><?php //echo base_url(); ?><!--logbook/psbtelkomsel">PSB Telkomsel</a></li>-->
                  ...
                  <li><a class="nav-link" href="<?php echo base_url(); ?>Tutupindihome/indihome_list">List Tutup Indihome</a></li>
...
<!--                  <li><a class="nav-link" href="--><?php //echo base_url(); ?><!--logbook/create">Workbook Telkomsel</a></li>-->
                  ...
                  <li><a class="nav-link" href="<?php echo base_url(); ?>Tutupindihome/indihome_test">Form Tutup Indihome</a></li>
...
<!--                  <li><a class="nav-link" href="--><?php //echo base_url(); ?><!--Starla_controller/plcsr">Starla</a></li>-->
            ...
            ?>
              ...
              <li class="dropdown <?php echo $this->uri->segment(2) == 'components_article' || $this->uri->segment(2) == 'components_avatar' || $this->uri->segment(2) == 'components_chat_box' || $this->uri->segment(2) == 'components_empty_state' || $this->uri->segment(2) == 'components_gallery' || $this->uri->segment(2) == 'components_hero' || $this->uri->segment(2) == 'components_multiple_upload' || $this->uri->segment(2) == 'components_pricing' || $this->uri->segment(2) == 'components_statistic' || $this->uri->segment(2) == 'components_tab' || $this->uri->segment(2) == 'components_table' || $this->uri->segment(2) == 'components_user' || $this->uri->segment(2) == 'components_wizard' ? 'active' : ''; ?>">
                  ...
                  <ul class="dropdown-menu">
                      <li class="<?php echo $this->uri->segment(2) == 'components_avatar' ? 'active' : ''; ?>"><a class="nav-link beep beep-sidebar" href="<?php echo base_url(); ?>user/ulist">User</a></li>
                      <li class="<?php echo $this->uri->segment(2) == 'components_wizard' ? 'active' : ''; ?>"><a class="nav-link beep beep-sidebar" href="<?php echo base_url(); ?>user/glist">Group</a></li>
<!--                      <li class="--><?php //echo $this->uri->segment(2) == 'components_wizard' ? 'active' : ''; ?><!--"><a class="nav-link beep beep-sidebar" href="--><?php //echo base_url(); ?><!--/laporan/resttimer">Laporan Aimer</a></li>-->
            ...
            <li class="menu-header">Laporan</li>
              <li class="dropdown <?php echo $this->uri->segment(2) == 'components_article' || $this->uri->segment(2) == 'components_avatar' || $this->uri->segment(2) == 'components_chat_box' || $this->uri->segment(2) == 'components_empty_state' || $this->uri->segment(2) == 'components_gallery' || $this->uri->segment(2) == 'components_hero' || $this->uri->segment(2) == 'components_multiple_upload' || $this->uri->segment(2) == 'components_pricing' || $this->uri->segment(2) == 'components_statistic' || $this->uri->segment(2) == 'components_tab' || $this->uri->segment(2) == 'components_table' || $this->uri->segment(2) == 'components_user' || $this->uri->segment(2) == 'components_wizard' ? 'active' : ''; ?>">
                  ...
                  <ul class="dropdown-menu">
                      <li class="<?php echo $this->uri->segment(2) == 'components_avatar' ? 'active' : ''; ?>"><a class="nav-link beep beep-sidebar" href="<?php echo base_url(); ?>laporan/indihome_laporan">All Laporan</a></li>
...
<!--                      <li class="--><?php //echo $this->uri->segment(2) == 'components_wizard' ? 'active' : ''; ?><!--"><a class="nav-link beep beep-sidebar" href="--><?php //echo base_url(); ?><!--/laporan/resttimer">Laporan Aimer</a></li>-->
              ...
              <li class="dropdown <?php echo $this->uri->segment(2) == 'utilities_invoice' ? 'active' : ''; ?>">
                  ...
                  <ul class="dropdown-menu">
                      <li><a href="<?php echo base_url(); ?>Excel_import/grapari">Grapari Own</a></li>
                      <li><a href="<?php echo base_url(); ?>Excel_import/graparimitra">Grapari Mitra</a></li>
                      <li><a href="<?php echo base_url(); ?>Excel_import/grapariloop">Grapari Loop</a></li>
                      <li><a href="<?php echo base_url(); ?>Excel_import/graparigtg">Grapari GTG</a></li>
                  </ul>
              </li>
...
<!--            </li>-->
            ...
            <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
                <a href="<?php echo base_url('upload'); ?>" class="btn btn-primary btn-lg btn-block btn-icon-split">
                    <i class="fas fa-upload"></i> Sign
                </a>
            </div>
